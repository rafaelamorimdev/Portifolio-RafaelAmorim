    ...
    id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                <h2 className="headline-2 lg:max-w-[120ch] reveal-up ">Entre em contato</h2>

                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[120ch] reveal-up">
                Entre em contato hoje mesmo para falarmos sobre as necessidades do seu projeto e darmos início a uma colaboração extraordinária!
                </p>
            ...
            <form 
            action="https://getform.io/f/agdyxznb" 
            method="POST"
            className="xl:pl-10 2xl:pl-20">
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2 ">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete="email"
                        required
                        placeholder="rafaelamorim@example.com"
                        className="text-field reveal-up"/>
                    </div>
                </div>
